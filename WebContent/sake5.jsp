...
<body>
	...
	<nav class="navbar navbar-default">
	    ...
	    <div class="img-container">
			<img width="45%" height="45%" src="image/oni.png" />
			<img width="50%" height="50%" src="image/r1.png" />
			<p>오니900</p>
			<p id="ddd">도찌기 평야의 좋은 쌀과 
시라네산 줄기의 맑은 물로 빚어내어 
입안에 착 감기는 듯 한 맛이 일품인 도깨비 술입니다.</p>
	    </div>
	    <div class="img-container">
			<img width="45%" height="45%" src="image/oni_rei.png" />
			<img width="50%" height="50%" src="image/r1.png" />
			<p>오니레이슈</p>
			<p id="ddd">일본 시라네산의 유명 휴양지인
기누가와 온천에서 유래한 도깨비 술로, 
차갑게 드시면 순하고 깔끔한 맛을
가장 잘 느끼실 수 있습니다.</p>
	    </div>
	    <div class="img-container">
			<img width="45%" height="45%" src="image/namajojo.png" />
			<img width="50%" height="50%" src="image/r1.png" />
			<p>나마죠조</p>
			<p id="ddd">출고 시 저온 살균 처리된 제품으로 
장기간의 유통에도 맛의 변질이 없이 
생주 특유의 경쾌하고 산뜻한 감칠맛을 
느낄 수 있는 冷사케입니다.</p>
	    </div>
	</div>
	</nav>
