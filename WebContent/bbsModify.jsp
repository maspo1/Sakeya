...
function modifyCheck() //수정체크함수 빈공간이 있는지 없는지 검사한다.
{
...
<body>
	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse"
			...
			<%} else{
			    ...
			    int idx= Integer.parseInt(request.getParameter("idx")); //from bbsView.jsp href link
	...
	<form name=modifyform method="post" action="bbsModifyAction.jsp?idx=<%=idx%>">
	<div class="container">
		<div class="row">
				<!--  회색 비슷하게 갈것이다. -->
					...
					<tbody>
						<tr>
							...
							<td><input type="text" class="form-control"
								 name="bbsTitle" maxlength="50" value="<%=bbsTitle %>"></td>
						</tr>
						<tr>
